...
export default function TrackClient({ initialOrders }: TrackClientProps) {
  const [orderId, setOrderId] = useState("");
  const [error, setError] = useState("");
  const router = useRouter();

  // Data is already loaded server-side — this is just the client's
  // working copy for filtering, not a fetch target.
